...
fn aes_128_comparison_test() {
  ...
  for _i in 0..1000 {
    ...
    assert_eq!(u128::from_be_bytes(expected_ciphertext), my_ciphertext, "AES-128 encryption failed.");
...
fn aes_192_comparison_test() {
    ...
    for _i in 0..1000 {
        ...
        let expected_ciphertext: [u8; 16] = expected_ciphertext
            .try_into()
            .expect("Expected ciphertext should be 16 bytes long");
        assert_eq!(u128::from_be_bytes(expected_ciphertext), my_ciphertext, "AES-192 encryption failed.");
...
fn aes_256_comparison_test() {
    ...
    for _i in 0..1000 {
        ...
        let expected_ciphertext: [u8; 16] = expected_ciphertext
            .try_into()
            .expect("Expected ciphertext should be 16 bytes long");
        assert_eq!(u128::from_be_bytes(expected_ciphertext), my_ciphertext, "AES-256 encryption failed.");
